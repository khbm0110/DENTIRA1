...
export default function ServiceEditForm({ lang, service }: { lang: string; service: any }) {
  ...
  const onSubmit = async (data: ServiceFormValues) => {
    ...
    try {
      await updateService(service.id, { ...data, image_url: imageUrl });
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Update this service offering.</p>
        </div>
      </div>
